...
function compareVersion(version1: string, version2: string): number {
  ...
  while (v1List.length || v2List.length) {
    const v1 = Number(v1List.shift() ?? 0);
    const v2 = Number(v2List.shift() ?? 0);
    if (v1 === v2) continue;
    return v1 > v2 ? 1 : -1;
  }
  return 0;
...
// console.log(compareVersion("1.1", "1.0.1") === 1);
// console.log(compareVersion("0.1", "1.1") === -1);
// console.log(compareVersion("1.0", "1.0.0") === 0);
// console.log(compareVersion("1.001.0203", "1.1.206") === -1);
